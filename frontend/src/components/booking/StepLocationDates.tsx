...
export const StepLocationDates: React.FC = () => {
  ...
  return (
    <form onSubmit={handleNext} className="max-w-3xl mx-auto p-8 md:p-10 rounded-3xl bg-white border border-zinc-200/80 shadow-lg flex flex-col gap-8">
      {/* Title */}
      ...
      <div className="flex items-center gap-4 p-2 rounded-2xl bg-zinc-100 w-fit">
        <button
          type="button"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <select
            ...
            className="w-full p-4 rounded-2xl bg-zinc-50 border border-zinc-200 text-sm font-semibold text-brand-charcoal focus:outline-none focus:border-brand-charcoal focus:ring-1 focus:ring-brand-charcoal cursor-pointer"
          >
            {HUBS.map((hub) => (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            required
            className="w-full p-4 rounded-2xl bg-zinc-50 border border-zinc-200 text-sm font-semibold text-brand-charcoal focus:outline-none focus:border-brand-charcoal cursor-pointer"
          />
        </div>
      ...
      <div className="p-4 rounded-2xl bg-zinc-100 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Clock className="w-5 h-5 text-brand-charcoal" />
          <span className="text-xs uppercase text-zinc-600 font-bold">
            {t('booking.duration')}:
          </span>
        </div>
        <span className="text-base font-extrabold text-brand-charcoal px-3 py-1 rounded-full bg-brand-lemon">
          {days} {t('booking.days')}
        </span>
      </div>
